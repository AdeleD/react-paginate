...
| `initialPage`            | `Number`   | The initial page selected, in [uncontrolled mode](https://reactjs.org/docs/uncontrolled-components.html). Do not use with `page` prop at the same time.                         |
| `page`                   | `Number`   | To control the selected page from parent. Use this if you want to [control](https://reactjs.org/docs/forms.html#controlled-components) the page from your app state.            |
| `forcePage`              | `Number`   | DEPRECATED: To change selected page from parent. Please use `page` prop instead to [control](https://reactjs.org/docs/forms.html#controlled-components) the page from your app. |
| `disableInitialCallback` | `boolean`  | Disable `onPageChange` callback with initial page. Default to `false` in uncontrolled mode and is always to `true` in controlled mode (when `page` prop is used).               |
