...
| `disableInitialCallback` | `boolean`  | Disable `onPageChange` callback with initial page. Default to `false` in uncontrolled mode and to `true` in controlled mode (when `page` prop is used).                         |
