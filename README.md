...
| `initialPage`            | `Number`   | The initial page selected, in [uncontrolled mode](https://reactjs.org/docs/uncontrolled-components.html). Do not use with `page` at the same time.                              |
...
| `forcePage`              | `Number`   | DEPRECATED: To change selected page with parent prop. Please use `page` instead to [control](https://reactjs.org/docs/forms.html#controlled-components) the page from your app. |
