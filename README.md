...
| `page`                   | `Number`   | To control the selected page with parent prop. Use this if you want to [control](https://reactjs.org/docs/forms.html#controlled-components) the page from your app state.            |
| `forcePage`              | `Number`   | DEPRECATED: To change selected page with parent prop. Please use `page` prop instead to [control](https://reactjs.org/docs/forms.html#controlled-components) the page from your app. |
