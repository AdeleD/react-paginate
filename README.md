...
| `hidePrevious`              | `Boolean`     | hide previous buttton and remove it's related li from DOM.                                                                                                                            |
| `nextLabel`              | `Node`     | Label for the `next` button.                                                                                                                                           |
| `hideNext`              | `Boolean`     | hide next buttton and remove it's related li from DOM.                                                                                                                                           |
...
| `hrefAllControls`            | `Boolean` | By default the `hrefBuilder` add `href` only to active controls. Set this prop to `true` so `href` are generated on all controls ([see](https://github.com/AdeleD/react-paginate/issues/242)).                                                                           |
